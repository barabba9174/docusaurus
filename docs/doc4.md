...
4. **Semantic markup is used to convey meaning and structure:**
...
5. **There are enough mechanisms in place to help users avoid and correct mistakes:**
...
6. **Ensure that the order of elements in the code matches the logical order of the information presented:**
...
8. **Non-standard interactive elements are meaningful:**
...
9. **All Interactive elements are accessible and there is a visible focus outline present:**
...
10. **Captcha has been avoided where possible:**
